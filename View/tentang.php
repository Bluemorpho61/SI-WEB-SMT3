      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6" data-aos="fade-left">
            <img src="../View/LandingPage/assets/img/undraw_svg_2.svg" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6" data-aos="fade-right">
            <img src="../View/LandingPage/assets/img/undraw_svg_3.svg" alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="section pb-0">
      <div class="container">
        <div class="row align-items-center mb-5">
          ...
          <div class="col-md-6" data-aos="fade-left">
            <img src="../View/LandingPage/assets/img/undraw_svg_4.svg"alt="Image" class="img-fluid">
          </div>
        </div>
      </div>
    </section>
