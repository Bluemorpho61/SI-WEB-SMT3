      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5" data-aos="fade">
          <div class="col-md-6 mb-5">
            <img src="assets/img/hp.png" alt="Image" class="img-fluid">
          </div>
        </div>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="review text-center">
                    ...
                    <p class="review-user">
                      <img src="assets/img/adam.jpeg" alt="Image" class="img-fluid rounded-circle mb-3">
                      <span class="d-block">
                ...
                <div class="swiper-slide">
                  <div class="review text-center">
                    ...
                    <p class="review-user">
                      <img src="assets/img/grace.jpeg" alt="Image" class="img-fluid rounded-circle mb-3">
                      <span class="d-block">
                ...
                <div class="swiper-slide">
                  <div class="review text-center">
                    ...
                    <p class="review-user">
                      <img src="assets/img/siska.jpeg" alt="Image" class="img-fluid rounded-circle mb-3">
                      <span class="d-block">
