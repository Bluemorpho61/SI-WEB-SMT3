    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a href="../View/fitur.php">Fitur</a></li>
          <li><a href="../View/akun.php">Akun Saya </a></li>
          <li><a href="../View/masuk.php">Masuk</a></li>
        </ul>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-5" data-aos="fade-up">
            <h2 class="section-heading">Temukan kemudahan dengan WarungKuy</h2>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Referensi makanan beragam</h3>
              <p>WarungKuy memiliki banyak sekali info kuliner menarik</p>
            </div>
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="100">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Fitur yang membantu</h3>
              <p>Fitur pada WarungKuy membantu anda untuk menemukan makanan yang sesuai dengan kemauan anda</p>
            </div>
          </div>
          <div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
            <div class="feature-1 text-center">
              ...
              <h3 class="mb-3">Bagikan Referensi Makanan Anda</h3>
              <p>Beri tau orang lain makanan apa yang menarik</p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5" data-aos="fade">
          <div class="col-md-6 mb-5">
            <img src="../View/LandingPage/assets/img/hp.png" alt="Image" class="img-fluid">
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="step">
              ...
              <h3>Enjoy the app</h3>
              <p>Nikmati fitur yang ada pada WarungKuy</p>
            </div>
          </div>
        </div>
      </div>
 ...
 <!-- ======= Testimonials Section ======= -->
    <section class="section border-top border-bottom">
      <div class="container">
        <div class="row justify-content-center text-center mb-5">
          <div class="col-md-4">
            <h2 class="section-heading">Review Dari Pengguna</h2>
          </div>
        </div>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="review text-center">
                    ...
                    <p class="review-user">
                      <img src="../View/LandingPage/assets/img/adam.jpeg" alt="Image" class="img-fluid rounded-circle mb-3">
                      <span class="d-block">
                        <span class="text-black">Adam</span>, &mdash; Pengguna
                      </span>
                    </p>
                ...
                <div class="swiper-slide">
                  <div class="review text-center">
                    ...
                    <h3>Aplikasinya sangat membantu</h3>
                    <blockquote>
                      <p>Jujur Maba seperti saya butuh banget aplikasi ini!</p>
                    </blockquote>

                    <p class="review-user">
                      <img src="../View/LandingPage/assets/img/grace.jpeg" alt="Image" class="img-fluid rounded-circle mb-3">
                      <span class="d-block">
                        <span class="text-black">Grace</span>, &mdash; Pengguna
                      </span>
                    </p>
                ...
                <div class="swiper-slide">
                  <div class="review text-center">
                    ...
                    <p class="review-user">
                      <img src="../View/LandingPage/assets/img/siska.jpeg" alt="Image" class="img-fluid rounded-circle mb-3">
                      <span class="d-block">
                        <span class="text-black">Siska</span>, &mdash; Pengguna
                      </span>
                    </p>
        ...
        <div class="col-md-7 ms-auto">
          <div class="row site-section pt-0">
            ...
            <div class="col-md-4 mb-4 mb-md-0">
              <h3>WarungKuy</h3>
              <ul class="list-unstyled">
                <li><a href="../View/tentang.php">Tentang Kami </a></li>
                <li><a href="../View/privasi.php">Kebijakan Privasi</a></li>
              </ul>
            </div>
            <div class="col-md-4 mb-4 mb-md-0">
              <h3>Download</h3>
